...
double integrate(FUNC f, double a, double b) {
  double sum = 0.0;
  double dx = 0.000001;
  // Loop through each rectangle and add its area to the total sum.
...
// These functions define the shape of the curves to be integrated.
...
// The main function calls the integrate function with each of the three curves and prints the results.
int main() {
